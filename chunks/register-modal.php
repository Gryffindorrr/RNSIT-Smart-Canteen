<section class="registermodal">
	<div id="modal2" class="modal">
	    <div class="modal-content center">
	      ...
	      <h5><small class="center" id="reg_error" style="color: #27265C;"></small></h5>
	      <form>
	    ...
	    <div class="row">
		  ...
		  <a href="javascript:void(0)" id="submit_reg" class="waves-effect waves-light btn" style="background: #27265C !important;">Register</a>
